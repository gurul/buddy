...
// in the area above the transcript HUD (landscape: y < 204).
// No padding assumed in the source art.
static const int   PEEK_TOP = 70;
static const int   HOME_AREA_H = 204;
...
static void gifPlace() {
  ...
  gifY = peekMode ? (PEEK_TOP - outH) / 2 : (HOME_AREA_H - outH) / 2;
}
