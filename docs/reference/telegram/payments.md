<!-- source: https://core.telegram.org/bots/payments · fetched 2026-09-23 -->

[ ](https://core.telegram.org/file/811140227/2/ZTXUngAbELM.193805/ba6aa233d1d4206207)
...
If the *max_tip_amount* parameter is set to above `0`, users can add a tip to their payment. You can use the parameter *suggested_tip_amounts* to suggest particular amounts that you feel will be relevant for the invoice.  [](https://core.telegram.org/file/464001701/6/-BJZJqe9VeA.70226/75a192d58d76dc96c1)

Adding Tips

#### 4. Shipping info and other details (optional step)

 The user specifies shipping information or other info requested by the bot. This could be the user's full name, an email address, a phone number in international format, or a full postal address for delivery.  [](https://core.telegram.org/file/464001896/2/9gTF8_aGQkE.45826/d5b11a999a40a1a6d9)
...
The user selects a delivery option from the list (the overall amount to be paid may change at this point) and proceeds to checkout.  [](https://core.telegram.org/file/464001836/2/rwUQeqMOsnI.31142/b0cc9d885ccb78ab39)
