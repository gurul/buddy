<!-- source: https://core.telegram.org/bots/games · fetched 2026-09-23 -->

[ ](https://core.telegram.org/file/811140373/1/0_42vz9chLs.975647/383dca94f028b1872c)

Bots can offer their users **HTML5 games** to play solo or to compete against each other in groups and one-on-one chats. Games are a new type of content on Telegram that your bot can send to users.  [](https://core.telegram.org/file/811140035/2/cIULSr61vi4.78261/127282e0bbd66ce3a9)
...
Since [April 2022](https://telegram.org/blog/notifications-bots#bot-revolution), you can also use [Web Apps](https://core.telegram.org/bots/webapps) to create powerful games using *JavaScript*.

>

Check out the [Web App Manual](https://core.telegram.org/bots/webapps) for details.
...
Once the game is created, your bot can send it to chats as regular messages, or offer them via [inline mode](https://core.telegram.org/bots/inline). The game message will always have an [inline](https://core.telegram.org/bots/api#inlinekeyboardmarkup) **Play button**.
...
The message with your game will also display high scores for the current chat. When a new high score is set, a service message will be sent to the chat and the message with the current scoreboard will be updated. You can also request the necessary data for building in-game high score tables.
 [](https://core.telegram.org/file/811140022/1/m7-46hgmwbI.91190/ad7033bcb879270a69) [](https://core.telegram.org/file/811140594/2/WS2fB3n2UGA.149087/270057ff677339717e)

### Sharing Your Game to Telegram Chats

There are many way for users to spread your game virally if they like it. The interface will always have the standard system button for sharing the game in the top right corner:  [](https://core.telegram.org/file/811140766/2/_wJtf-Zib5I.25531/774eb9b59898526d26) [](https://core.telegram.org/file/811140557/3/ddi8K6x0obQ.34056/a1ca60069b70a81646)

You can also create an additional **Share** button inside your HTML page. Pressing this button will send the game to a desired chat along with the user's best score in the game.  [](https://core.telegram.org/file/811140189/2/SLwHmToemfg.91233/a242854be2b500b4cb) [](https://core.telegram.org/file/811140978/1/JoBvEad8JaM.148942/dcd741b65b446781b4)
...
See the [Bot API Manual](https://core.telegram.org/bots/api#games) for the relevant methods and objects.
