<!-- source: https://core.telegram.org/bots/faq · fetched 2026-09-23 -->

>

If you are new to Telegram bots, we recommend checking out our [**Introduction to Bots**](https://core.telegram.org/bots) first. You may also find the **[Bot API Manual](https://core.telegram.org/bots/api)** useful.
...
Many members of our community are building bots and publishing sources. We're collecting them on [**this page »**](https://core.telegram.org/bots/samples)
...
If you'd like to make sure that the Webhook request comes from Telegram, we recommend using a secret path in the URL you give us, e.g. [www.example.com/your_token](http://www.example.com/your_token). Since nobody else knows your bot's token, you can be pretty sure it's us.
...
**1. Issue POST to [https://api.telegram.org/bot](https://api.telegram.org/bot)/method**  [](https://core.telegram.org/file/811140979/3/5p52TWl9X2o/5c6d684ee0d6a4399d)
